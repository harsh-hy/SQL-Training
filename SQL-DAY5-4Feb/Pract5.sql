...
DROP INDEX IF EXISTS IX_perf_issue_BusinessEntityID
ON perf_issue;
GO
--slow search
SELECT *
...
GO
CREATE CLUSTERED INDEX IX_perf_issue_BusinessEntityID
ON perf_issue (BusinessEntityID);
GO
--fast search
SELECT *
FROM perf_issue
...
DROP INDEX IF EXISTS IX_perf_issue_LastName_FirstName
ON perf_issue;
GO
--slow search
SELECT *
...
AND FirstName = 'John';
GO
CREATE NONCLUSTERED INDEX IX_perf_issue_LastName_FirstName
ON perf_issue (LastName, FirstName);
GO
--fast search
SELECT *
FROM perf_issue
